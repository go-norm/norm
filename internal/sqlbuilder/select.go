...
func (s *selector) From(tables ...interface{}) norm.Selector {
	...
	return s.frame(func(sq *selectorQuery) error {
		...
		sq.table = exql.Columns(fragments...)
		sq.tableArgs = args
		return nil
	})
}
...
func (s *selector) As(alias string) norm.Selector {
	return s.frame(func(sq *selectorQuery) error {
		...
		raw, ok := sq.table.Columns[last].(*exql.RawFragment)
		if !ok {
			return nil
		}
...
func (s *selector) Where(conds ...interface{}) norm.Selector {
	...
	return s.frame(func(sq *selectorQuery) error {
		...
		return errors.Wrap(sq.and(s.Builder().t, conds...), "WhereFragment")
	})
}
...
func (s *selector) And(conds ...interface{}) norm.Selector {
	...
	return s.frame(func(sq *selectorQuery) error {
		return errors.Wrap(sq.and(s.Builder().t, conds...), "AndFragment")
	})
}
...
func (sq *selectorQuery) pushColumns(exprs []interface{}) error {
	...
	columns := exql.Columns(fragments...)
	if sq.columns != nil {
...
func (sq *selectorQuery) and(t *template, conds ...interface{}) error {
	...
	if sq.where == nil {
		sq.where, sq.whereArgs = &exql.WhereFragment{}, []interface{}{}
	}
