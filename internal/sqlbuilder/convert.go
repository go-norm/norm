...
// Preprocess expands arguments that need to be expanded and compiles a query
// into a single string.
func Preprocess(query string, args []interface{}) (string, []interface{}) {
	return expandQuery(query, args, preprocessFn)
}
