...
func TestSelectFieldsFromWithOrderBy(t *testing.T) {
	...
	stmt = Statement{
		...
		OrderBy: JoinWithOrderBy(
			JoinSortColumns(
				&SortColumn{Column: &Column{Name: "foo"}, Order: Ascendant},
			),
		),
		Table: TableWithName("table_name"),
	}
	...
	stmt = Statement{
		...
		OrderBy: JoinWithOrderBy(
			JoinSortColumns(
				&SortColumn{Column: &Column{Name: "foo"}, Order: Descendent},
				&SortColumn{Column: &Column{Name: "bar"}, Order: Ascendant},
	...
	stmt = Statement{
		...
		OrderBy: JoinWithOrderBy(
			JoinSortColumns(
				...
				&SortColumn{Column: &Column{Name: Raw{Value: "BAR()"}}, Order: Ascendant},
			),
		),
		Table: TableWithName("table_name"),
	}
